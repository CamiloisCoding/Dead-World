...
rooms = {
    ...
    'östliche_skyscraper2_straße': {#Stadt
        ...
        'exits': {'norden': 'süd_östliche_skyscraper_weggabelung', 'osten': 'oestlich_skyscraper2_erweiterung' },
        'items': [],
        'in_development': True,
        'spawn_chance': False,
        'zombie_spawn': False
    ...
    'westliche_skyscraper2_weggabelung': {#Stadt
        ...
        'exits': {'norden': 'skyscraper_weggabelung', 'westen': 'südliche_pizzeria_straße', 'süden': 'südlich_skyscraper2_straße' },
        'items': [],
        'in_development': True,
        'spawn_chance': False,
        'zombie_spawn': False
    ...
    'mickey_mouse_eingang': {  # NEW (map integration)
        'name': 'Mickey Mouse Club House - Eingang',
        'description': 'Du betrittst ein Club House mit Mickey-Ohren auf dem Dach. Mickey-Fußspuren führen rein. Im SÜDEN ist die Mickey Mouse Straße zurück. Im OSTEN siehst du den Spielraum, im WESTEN die Story Corner.',
        'exits': {'süden': 'mickey_mouse_straße', 'osten': 'mickey_mouse_spielraum', 'westen': 'mickey_mouse_storycorner'},
        'items': ['plüschtier'],
        'in_development': True,
    },
    'mickey_mouse_spielraum': {  # NEW (map integration)
        'name': 'Mickey Mouse - Spielraum',
        'description': 'Spielzeugkisten, ein riesiger Plüschball, ein Puppenhaus und eine grüne Spielmatte. Lustig - aber etwas unheimlich in der Apokalypse.',
        'exits': {'westen': 'mickey_mouse_eingang'},
        'items': ['ball', 'plüschtier'],
        'in_development': True,
    },
    'mickey_mouse_storycorner': {  # NEW (map integration)
        'name': 'Mickey Mouse - Story Corner',
        'description': 'Bunte Bücher in den Regalen, ein gemütliches Sofa, ein orangener Teppich, eine "Reading Nook" Holzbox.',
        'exits': {'osten': 'mickey_mouse_eingang'},
        'items': ['kinderbuch'],
        'in_development': True,
    },
    ...
    'bruce_wayne_eingang': {  # NEW (map integration)
        'name': 'Bruce Wayne Manor - Foyer',
        'description': 'Eine doppelte grüne Tür öffnet sich in eine prunkvolle Eingangshalle. Marmorboden, ein riesiger Kronleuchter, eine Treppe nach oben. Im SÜDEN führt es nach draußen. Im OSTEN die Küche. Im WESTEN das Wohnzimmer. Im NORDEN die Bibliothek (mit einem geheimen Bücherregal!).',
        'exits': {'süden': 'bruce_wayne_straße', 'osten': 'bruce_wayne_küche', 'westen': 'bruce_wayne_wohnzimmer', 'norden': 'bruce_wayne_library'},
        'items': ['kronleuchter_kristall'],
        'in_development': True,
    },
    'bruce_wayne_wohnzimmer': {  # NEW (map integration)
        'name': 'Bruce Wayne - Wohnzimmer',
        'description': 'Reich verzierte braune Couches, ein roter Teppich, ein Kamin mit knisterndem Feuer (wer hat das angemacht?). Antike Statue in der Ecke.',
        'exits': {'osten': 'bruce_wayne_eingang'},
        'items': ['antike_statue'],
        'in_development': True,
    },
    'bruce_wayne_küche': {  # NEW (map integration)
        'name': 'Bruce Wayne - Küche',
        'description': 'Eine Profi-Küche mit zwei Öfen, einer Kühlschrank-Kammer, riesiger Insel und Speisekammer. Hinten ein eleganter Esstisch.',
        'exits': {'westen': 'bruce_wayne_eingang'},
        'items': ['gourmet_messer', 'wein'],
        'in_development': True,
    },
    'bruce_wayne_library': {  # NEW (map integration)
        'name': 'Bruce Wayne - Bibliothek',
        'description': 'Boden-zu-Decke Bücherregale. Ein roter Teppich, eine Lese-Ecke. Ein einzelnes Bücherregal sieht... seltsam aus. Es gibt einen kleinen "?" in roter Schrift. Im SÜDEN ist das Foyer. Wenn du das Geheimnis findest, geht es RUNTER zum Batcave.',
        'exits': {'süden': 'bruce_wayne_eingang', 'runter': 'batcave_garage'},
        'items': ['altes_buch', 'geheimnis'],
        'in_development': True,
    },
    'bruce_wayne_master': {  # NEW (map integration)
        'name': 'Bruce Wayne - Master Bedroom',
        'description': 'Riesiges Doppelbett, Walk-in-Closet, eigenes Master Bath. Geheime Sachen unter der Matratze.',
        'exits': {'westen': 'bruce_wayne_library'},
        'items': ['rolex'],
        'in_development': True,
    },
    'batcave_garage': {  # NEW (map integration)
        'name': 'Batcave - Garage',
        'description': '🦇 BATCAVE. Höhle aus poliertem schwarzem Stein. Das BATMOBILE steht im Zentrum. Ein Tunnel führt HOCH zur Manor-Bibliothek. Im NORDEN sind die Bat-Computer. Im OSTEN die Bat-Suit-Vitrinen. Im SÜDEN der Trainings-Bereich.',
        'exits': {'hoch': 'bruce_wayne_library', 'norden': 'batcave_computer', 'osten': 'batcave_suits', 'süden': 'batcave_training'},
        'items': ['batarang'],
        'in_development': True,
    },
    'batcave_computer': {  # NEW (map integration)
        'name': 'Batcave - Bat-Computer',
        'description': 'Sechs gigantische Monitore zeigen Live-Kameras. Tastatur und ein leerer Stuhl. JARVIS-ähnliche grüne Schrift flackert.',
        'exits': {'süden': 'batcave_garage'},
        'items': ['datenträger'],
        'in_development': True,
    },
    'batcave_suits': {  # NEW (map integration)
        'name': 'Batcave - Bat-Suit-Vitrinen',
        'description': 'Vier Bat-Suits in beleuchteten Vitrinen. Verschiedene Designs - leicht, schwer, Tarnung, Panzerung.',
        'exits': {'westen': 'batcave_garage'},
        'items': ['bat_suit_modul'],
        'in_development': True,
    },
    'batcave_training': {  # NEW (map integration)
        'name': 'Batcave - Trainings-Bereich',
        'description': 'Sandsack, ein Sparring-Ring, ein Bat-Arsenal mit Waffen-Ständern. Hier hat sich Bruce wohl täglich gestählt.',
        'exits': {'norden': 'batcave_garage'},
        'items': ['sandsack'],
        'in_development': True,
    },
    ...
    'berg_höhle': {  # NEW (map integration)
        'name': 'Berg - Höhle',
        'description': 'Ein dunkles Höhlenmaul am Fuß des Berges. Drinnen kühl und feucht.',
        'exits': {'norden': 'berg'},
        'items': ['stalaktit'],
        'in_development': True,
    },
    'berg_hütte': {  # NEW (map integration)
        'name': 'Berghütte',
        'description': 'Eine kleine Holzhütte mit rotem Dach. Drinnen ein Bett, ein Tisch, zwei kleine Fenster.',
        'exits': {'westen': 'berg'},
    ...
    'amusement_riesenrad': {  # NEW (map integration)
        'name': 'Riesenrad',
        'description': 'Ein gewaltiges, stillstehendes Riesenrad. Acht bunte Kabinen baumeln. Du kannst hineinklettern.',
        'exits': {'süden': 'amusement_eingang'},
        'items': ['ferris_token'],
        'in_development': True,
    },
    ...
    'joestar_joseph': {  # NEW (map integration)
        'name': 'Joestar - Josephs Zimmer',
        'description': '"Oh no!" Krimskrams überall. Joseph war wohl... eklektisch.',
        'exits': {'osten': 'joestar_jonathan'},
        'items': ['kleenex'],
        'in_development': True,
    },
    'joestar_jotaro': {  # NEW (map integration)
        'name': 'Joestar - Jotaros Zimmer',
        'description': '"Yare yare daze." Schlicht, dunkel. Eine Schul-Uniform am Schrank. Ein Schulhut auf dem Bett.',
        'exits': {'westen': 'joestar_jonathan'},
        'items': ['stand_disc'],
        'in_development': True,
    },
    ...
    'casino_floor': {  # NEW (map integration)
        'name': 'Casino - Floor',
        'description': 'Roter Teppich. Slot-Maschinen klimpern noch (irgendwie?). Drei Blackjack-Tische, zwei Roulette-Räder. Eine Bar im Hintergrund. Im OSTEN die VIP-Lounge. Im WESTEN der Tresor.',
        'exits': {'süden': 'casino_eingang', 'osten': 'casino_vip', 'westen': 'casino_vault'},
        'items': ['casino_chip', 'spielkarte'],
        'in_development': True,
    },
    'casino_vip': {  # NEW (map integration)
        'name': 'Casino - VIP Room',
        'description': 'Schwarz mit goldenem Rand. Braune Ledersofas, ein Tisch. Hier spielten die Reichen.',
        'exits': {'westen': 'casino_floor'},
        'items': ['goldener_chip'],
        'in_development': True,
    },
    'casino_vault': {  # NEW (map integration)
        'name': 'Casino - Tresor',
        'description': 'Stahlwände, ein massiver Tresor. Voller Bargeld-Stapel.',
        'exits': {'osten': 'casino_floor'},
    ...
    'stark_lab': {  # NEW (map integration)
        'name': 'Stark Tower - Lab (F2)',
        'description': 'Werkbänke, Computer, Schweißgeräte. "J.A.R.V.I.S." in grünen Buchstaben auf einem Panel. HOCH zum Penthouse, RUNTER zur Lobby.',
        'exits': {'runter': 'stark_lobby', 'hoch': 'stark_penthouse'},
        'items': ['arc_reactor_teil'],
        'in_development': True,
    },
    'stark_penthouse': {  # NEW (map integration)
        'name': "Stark Tower - Tony's Penthouse (F3)",
        'description': 'Eine pinke Bar, Couches, ein Doppelbett, ein gigantisches Stadtansichts-Fenster. Im RUNTER zum Lab, HOCH zum Suit Workshop.',
        'exits': {'runter': 'stark_lab', 'hoch': 'stark_suits'},
        'items': ['whiskey'],
        'in_development': True,
    },
    'stark_suits': {  # NEW (map integration)
        'name': 'Stark Tower - Suit Workshop (F4)',
        'description': 'SECHS Iron-Man-Anzüge in einer Reihe: Mark 1 bis 6. Cool. RUNTER zum Penthouse, HOCH zum Helipad.',
        'exits': {'runter': 'stark_penthouse', 'hoch': 'stark_helipad'},
        'items': ['anzug_modul'],
        'in_development': True,
    },
    'stark_helipad': {  # NEW (map integration)
        'name': 'Stark Tower - Helipad (F5)',
        'description': 'Das Dach. Ein "H" für Helicopter. Wind. Aussicht über die ganze Stadt. RUNTER zum Suit Workshop.',
        'exits': {'runter': 'stark_suits'},
        'items': ['kompass'],
        'in_development': True,
    },
    ...
    'disco_dj': {  # NEW (map integration)
        'name': 'Discotec - DJ-Booth',
        'description': 'Zwei Plattenspieler, ein Mischpult mit grünen LEDs. Kopfhörer hängen am Haken.',
        'exits': {'süden': 'disco_tanzfläche'},
        'items': ['vinyl'],
        'in_development': True,
    },
    'disco_vip': {  # NEW (map integration)
        'name': 'Discotec - VIP-Bereich',
        'description': 'Lila-goldener Bereich. Plüsch-Ledersofas, ein Tisch, Champagner-Reste.',
        'exits': {'osten': 'disco_tanzfläche'},
        'items': ['champagner'],
        'in_development': True,
    },
    'disco_bar': {  # NEW (map integration)
        'name': 'Discotec - Bar',
        'description': 'Eine lange Bar mit gelben Flaschen. Rote Bar-Hocker.',
        'exits': {'westen': 'disco_tanzfläche'},
        'items': ['cocktail'],
        'in_development': True,
    },
    ...
    'wald_osten': {  # NEW (map integration)
        'name': 'Wald - Osten',
        'description': 'Ein heller Mischwald östlich der Stadt. Pinien, breite Laubbäume.',
        'exits': {'westen': 'oestlich_skyscraper2_erweiterung'},
        'items': ['holz'],
        'in_development': True,
    },
    'wald_fluss_osten': {  # NEW (map integration)
        'name': 'Wald / Fluss - Osten',
        'description': 'Ein anderer Fluss, schmaler. Hier rasten Tiere. Wenn du genau hinhörst...',
        'exits': {'westen': 'oestlich_skyscraper2_erweiterung_süd'},
        'items': ['frisches_wasser'],
        'in_development': True,
    },
    ...
    'university_eingang': {  # NEW (map integration)
        'name': 'University - Eingang',
        'description': 'Eine massive lila-akzentuierte Eingangstür. Hinein zur Lecture Hall. Im NORDEN die Strecke zurück. Im OSTEN die Library, im WESTEN die Dorms.',
        'exits': {'norden': 'weiter_westlich_straße', 'osten': 'university_library', 'westen': 'university_dorm'},
        'items': ['textbuch'],
        'in_development': True,
    },
    'university_library': {  # NEW (map integration)
        'name': 'University - Library',
        'description': 'Riesige Bibliothek mit Bücherregalen. Lese-Bereiche, Studienplätze. Hier könnte man sich gut verstecken.',
        'exits': {'westen': 'university_eingang'},
        'items': ['lehrbuch', 'forschungsnotiz'],
        'in_development': True,
    },
    'university_dorm': {  # NEW (map integration)
        'name': 'University - Dorms',
        'description': 'Vier Studenten-Wohnheime. Bett, Schreibtisch, Schrank, eine kleine Chill-Ecke pro Zimmer.',
        'exits': {'osten': 'university_eingang'},
    ...
    'lab_datacenter': {  # NEW (map integration)
        'name': 'Lab - Datacenter',
        'description': 'Acht Server mit grün blinkenden LEDs. Hier laufen wichtige Daten - oder eher: liefen.',
        'exits': {'norden': 'lab_eingang'},
        'items': ['festplatte'],
        'in_development': True,
    },
    ...
    'sex_dungeon_hauptraum': {  # NEW (map integration)
        'name': 'Sexdungeon - Hauptraum',
        'description': 'Schwarz-rotes Dungeon. Bett, mysteriöse Gerätschaften (???). Stille Beleuchtung.',
        'exits': {'norden': 'sex_dungeon_eingang'},
        'items': [],
        'in_development': True,
    },
    ...
    'military_barracks': {  # NEW (map integration)
        'name': 'Military - Barracks',
        'description': 'Zwanzig Etagenbetten in Reihen. Spind. Spinde. Spinde.',
        'exits': {'süden': 'military_eingang'},
        'items': ['camo_jacke', 'erkennungsmarke'],
        'in_development': True,
    },
    ...
    'hacienda_wohnzimmer': {  # NEW (map integration)
        'name': 'Hacienda - Salón',
        'description': 'Großer Salon im spanischen Stil. Dunkles Holz, Mosaikboden, ein Kamin.',
        'exits': {'osten': 'hacienda_eingang'},
        'items': ['zigarre'],
        'in_development': True,
    },
    'hacienda_küche': {  # NEW (map integration)
        'name': 'Hacienda - Cocina',
        'description': 'Eine spanische Küche mit Gewürzregalen, einem riesigen Steinofen.',
        'exits': {'westen': 'hacienda_eingang'},
        'items': ['gewürze', 'tortillas'],
        'in_development': True,
    },
    'hacienda_pablo': {  # NEW (map integration)
        'name': "Hacienda - Pablo's Room",
        'description': 'Ein einfaches Schlafzimmer mit königlicher Aura. Spitzbart-Foto an der Wand.',
        'exits': {'norden': 'hacienda_eingang', 'süden': 'hacienda_lab'},
        'items': ['cigarre', 'foto'],
        'in_development': True,
    },
    'hacienda_lab': {  # NEW (map integration)
        'name': 'Hacienda - Hidden Lab 🤐',
        'description': 'Ein verstecktes Labor mit zwei Process-Bänken und Ziegeln aus weißem Pulver. Du solltest hier vielleicht nicht sein.',
        'exits': {'norden': 'hacienda_pablo', 'osten': 'hacienda_vault', 'süden': 'hacienda_pool'},
        'items': ['weisses_pulver_brick'],
        'in_development': True,
    },
    'hacienda_vault': {  # NEW (map integration)
        'name': 'Hacienda - Money Vault',
        'description': 'Ein grüner Raum voller Geldbündel. Reich. Sehr reich.',
        'exits': {'westen': 'hacienda_lab'},
        'items': ['bargeld', 'goldbarren'],
        'in_development': True,
    },
    'hacienda_pool': {  # NEW (map integration)
        'name': 'Hacienda - Pool & Hippos 🦛',
        'description': "Ein riesiger Swimming Pool. Daneben drei nilpferdähnliche Wesen - Pablo's Hippos!",
        'exits': {'norden': 'hacienda_lab'},
        'items': ['leguan_haut'],
        'in_development': True,
    },
    ...
    'prison_yard': {  # NEW (map integration)
        'name': 'Prison - Yard',
        'description': 'Außenbereich mit Basketball-Korb, Gewichtsbank, Picknicktisch. Drei "Spaziergänger" laufen Runden.',
        'exits': {'norden': 'prison_eingang'},
        'items': ['basketball'],
        'in_development': True,
    },
    ...
    'capsule_gravity': {  # NEW (map integration)
        'name': 'Capsule Corp - Gravity Chamber',
        'description': 'Eine rote Kugel: 100x Gravitation. Beim Betreten wirst du dich superschwer fühlen.',
        'exits': {'norden': 'capsule_eingang'},
        'items': [],
        'in_development': True,
    },
    ...
    'bunker_bunks': {  # NEW (map integration)
        'name': 'Bunker - Bunk Room',
        'description': 'Acht Etagenbetten. Hier könnte man schlafen.',
        'exits': {'norden': 'bunker_eingang'},
        'items': ['decke'],
        'in_development': True,
    },
    ...
    'doof_workshop': {  # NEW (map integration)
        'name': 'Doof Inc. - -inator Workshop',
        'description': 'Sechs verschiedene -inators: Freeze, Shrink, Other, Mind Control, Tomato, Smelly. Jeder ein neuer Plan. RUNTER zur Lobby, HOCH zum Penthouse.',
        'exits': {'runter': 'doof_eingang', 'hoch': 'doof_penthouse'},
        'items': ['freeze_inator_teil'],
        'in_development': True,
    },
    'doof_penthouse': {  # NEW (map integration)
        'name': 'Doof Inc. - Penthouse',
        'description': 'Heinz\'s Schlafplatz, eine Perry-Pen, der "Big -INATOR". RUNTER zum Workshop, HOCH zum Roof.',
        'exits': {'runter': 'doof_workshop', 'hoch': 'doof_roof'},
        'items': ['heinz_robe'],
        'in_development': True,
    },
    'doof_roof': {  # NEW (map integration)
        'name': 'Doof Inc. - Roof',
        'description': 'Ein riesiger roter Knopf: "PRESS ME!". Bezeichnet als "SELF-DESTRUCT BUTTON". Du solltest ihn vermutlich NICHT drücken. "Curse you Perry the Platypus!"',
        'exits': {'runter': 'doof_penthouse'},
        'items': [],
        'in_development': True,
    },
    ...
    'studio_control': {  # NEW (map integration)
        'name': 'Studio - Control Room',
        'description': 'Wand voller Monitore (12 Stück!), Mischpult mit Reglern.',
        'exits': {'norden': 'studio_eingang'},
        'items': ['kassette'],
        'in_development': True,
    },
...
BUILDING_HIERARCHY = {
    ...
    # ========================================================================
    # NEW BUILDINGS (from map integration)
    # ========================================================================
    'mickey_mouse_clubhouse': {
        'name': 'Mickey Mouse Club House',
        'floors': {'main': ['mickey_mouse_eingang', 'mickey_mouse_spielraum', 'mickey_mouse_storycorner']},
    },
    'strand': {
        'name': 'Strand',
        'floors': {'main': ['strand', 'strand_brücke']},
    },
    'bruce_wayne_manor': {
        'name': 'Bruce Wayne Manor',
        'floors': {'main': ['bruce_wayne_eingang', 'bruce_wayne_wohnzimmer', 'bruce_wayne_küche', 'bruce_wayne_library', 'bruce_wayne_master']},
    },
    'batcave': {
        'name': 'Batcave',
        'floors': {'main': ['batcave_garage', 'batcave_computer', 'batcave_suits', 'batcave_training']},
    },
    'forest': {
        'name': 'Wald',
        'floors': {'main': ['wald_nordwest', 'wald_norden', 'wald_fluss', 'wald_osten', 'wald_fluss_osten', 'wald_haus_eingang', 'wald_haus_drinnen']},
    },
    'mountain': {
        'name': 'Berg',
        'floors': {'main': ['berg', 'berg_höhle', 'berg_hütte']},
    },
    'amusement_park': {
        'name': 'Amusement Park',
        'floors': {'main': ['amusement_eingang', 'amusement_riesenrad', 'amusement_achterbahn', 'amusement_karussell']},
    },
    'joestar_mansion': {
        'name': 'Joestar Mansion',
        'floors': {'main': ['joestar_eingang', 'joestar_wohnzimmer', 'joestar_küche', 'joestar_jonathan', 'joestar_joseph', 'joestar_jotaro']},
    },
    'pollos_hermanos': {
        'name': 'Los Pollos Hermanos',
        'floors': {'main': ['pollos_eingang', 'pollos_küche']},
    },
    'casino': {
        'name': 'Casino',
        'floors': {'main': ['casino_eingang', 'casino_floor', 'casino_vip', 'casino_vault']},
    },
    'stark_tower': {
        'name': 'Stark Tower',
        'floors': {
    ...
    'cinema': {
        'name': 'Cinema',
        'floors': {'main': ['cinema_eingang', 'cinema_saal1', 'cinema_saal2']},
    },
    'discotec': {
        'name': 'Discotec',
        'floors': {'main': ['disco_eingang', 'disco_tanzfläche', 'disco_dj', 'disco_vip', 'disco_bar']},
    },
    'time_square': {
        'name': 'Time Square',
        'floors': {'main': ['timesquare']},
    },
    'maze': {
        'name': 'Maze',
        'floors': {'main': ['maze_eingang', 'maze_zentrum']},
    },
    'graveyard': {
        'name': 'Friedhof',
        'floors': {'main': ['friedhof_eingang', 'friedhof_krypta']},
    },
    'town_hall': {
        'name': 'Town Hall',
        'floors': {'main': ['town_hall_eingang', 'town_hall_office', 'town_hall_conference']},
    },
    'university': {
        'name': 'University',
        'floors': {'main': ['university_eingang', 'university_library', 'university_dorm']},
    },
    'waterpark': {
        'name': 'Waterpark',
        'floors': {'main': ['waterpark_eingang', 'waterpark_pool', 'waterpark_slides']},
    },
    'storage_units': {
        'name': 'Storage Units',
        'floors': {'main': ['storage_eingang']},
    },
    'laboratory_district': {
        'name': 'Laboratory',
        'floors': {'main': ['lab_eingang', 'lab_chemie', 'lab_biologie', 'lab_datacenter']},
    },
    'fire_dept': {
        'name': 'Fire Department',
        'floors': {'main': ['feuerwehr_eingang', 'feuerwehr_garage', 'feuerwehr_schlafraum', 'feuerwehr_training']},
    },
    'sex_dungeon': {
        'name': 'Sexdungeon',
        'floors': {'main': ['sex_dungeon_eingang', 'sex_dungeon_lounge', 'sex_dungeon_hauptraum']},
    },
    'military_base': {
        'name': 'Military Base',
        'floors': {'main': ['military_eingang', 'military_barracks', 'military_messhall', 'military_armory', 'military_vehicles']},
    },
    'hacienda_napoles': {
        'name': 'Hacienda Nápoles',
        'floors': {'main': ['hacienda_eingang', 'hacienda_wohnzimmer', 'hacienda_küche', 'hacienda_pablo', 'hacienda_lab', 'hacienda_vault', 'hacienda_pool']},
    },
    'prison': {
        'name': 'Prison',
        'floors': {'main': ['prison_eingang', 'prison_zellen', 'prison_yard', 'prison_cafeteria']},
    },
    'stadium': {
        'name': 'Stadium',
        'floors': {'main': ['stadium_eingang', 'stadium_feld', 'stadium_tribuene', 'stadium_food']},
    },
    'capsule_corp': {
        'name': 'Capsule Corp',
        'floors': {'main': ['capsule_eingang', 'capsule_lab', 'capsule_haus', 'capsule_gravity']},
    },
    'city_bunker': {
        'name': 'Bunker (City)',
        'floors': {'main': ['bunker_eingang', 'bunker_vaults', 'bunker_supplies', 'bunker_bunks']},
    },
    'doof_inc': {
        'name': 'Doofenshmirtz Evil Inc.',
        'floors': {
            'lobby': ['doof_eingang'],
            'workshop': ['doof_workshop'],
            'penthouse': ['doof_penthouse'],
            'roof': ['doof_roof'],
        },
    },
    'studio': {
        'name': 'Studio',
        'floors': {'main': ['studio_eingang', 'studio_news', 'studio_drama', 'studio_control']},
    },
    'construction_site': {
        'name': 'Construction Site',
        'floors': {'main': ['bau_eingang', 'bau_tower', 'bau_kran', 'bau_material']},
    },
    'airport': {
        'name': 'Airport',
        'floors': {'main': ['airport_terminal', 'airport_warten', 'airport_runway', 'airport_security']},
    },
    'fairy_valley': {
        'name': 'Fairy Valley',
        'floors': {'main': ['feen_tal']},
    },
    'valley_clearing': {
        'name': 'Valley / Clearing',
        'floors': {'main': ['tal_lichtung']},
    },
    'landscape': {
        'name': 'Landschaft',
        'floors': {'main': ['landschaft']},
    },
    'expansion_streets': {
        'name': 'Erweiterungs-Straßen',
        'floors': {'main': ['noerdlich_walmart_straße', 'mickey_mouse_straße', 'strand_straße', 'bruce_wayne_straße',
                            'oestlich_park_erweiterung', 'oestlich_skyscraper2_erweiterung', 'oestlich_skyscraper2_erweiterung_süd',
                            'westlich_krankenhaus_erweiterung', 'weiter_westlich_straße', 'westlich_süd_straße',
                            'südlich_skyscraper2_straße', 'weit_süd_landschaft']},
    },
}
